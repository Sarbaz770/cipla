            ...
            <div>
                ...
                <div className="container-fluid">
                    <div className="row flex-xl-nowrap">
                        ...
                        {/* <!-- sidebar end --> */}
                        <div id="content-body" className="col-12 col-md-12 col-xl-12 pl-4 pr-4 bd-content">
                            {/* <!-- heading row --> */}
                            <div className="row">
                    ...
                    <!-- chart row start -->  */}
                            <div className="row mt-3 db-chart">
                                ...
                                <div id="parent3" className="col-lg-6 col-xl-4">
                                    <div className="chart-card mb-4">
                                        <div className="chart-title" id="text3">Specific Energy Consumption</div>
                                        <div id="chart3" className="chart">Chart 3</div>
                                    </div>
                                </div>
                                <div id="parent4" className="col-lg-6 col-xl-4">
                                    <div className="chart-card mb-4">
                                        <div className="chart-title" id="text4">ACTIVE SYSTEMS</div>
                                ...
                                <div id="parent8" className="col-lg-6 col-xl-4">
                                    <div className="chart-card mb-4">
                                        <div className="chart-title" id="text6">CHILLER COP COMPARISON</div>
